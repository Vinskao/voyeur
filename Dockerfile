...
ENV VOYEUR_SECRET_KEY=${VOYEUR_SECRET_KEY}
...
ENV REDIS_QUEUE_VOYEUR=${REDIS_QUEUE_VOYEUR}
ENV WEBSOCKET_TYMB=${WEBSOCKET_TYMB}
...
# 拷貝 consumer.py
COPY k8s/consumer.py /app/consumer.py
